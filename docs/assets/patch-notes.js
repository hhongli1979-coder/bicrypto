...
class PatchNotesSystem {
  constructor() {
    ...
    this.cacheVersion = "1.0.594380"; // Update this when deploying changes
    this.extensionIcons = {
      core: "🚀",
      "ai-investment": "🤖",
      "ai-market-maker": "📊",
    ...
    this.extensionColors = {
      ...
      "ai-investment": "from-cyan-500 to-purple-600",
      "ai-market-maker": "from-cyan-500 to-purple-600",
      affiliate: "from-blue-500 to-amber-600",
      "copy-trading": "from-emerald-500 to-teal-600",
      ecommerce: "from-amber-500 to-emerald-600",
      ecosystem: "from-blue-500 to-cyan-600",
      faq: "from-sky-500 to-blue-600",
      forex: "from-emerald-500 to-teal-600",
      futures: "from-amber-500 to-red-600",
      gateway: "from-indigo-500 to-cyan-600",
      ico: "from-teal-500 to-cyan-600",
      mailwizard: "from-violet-500 to-rose-600",
      nft: "from-purple-500 to-pink-600",
      p2p: "from-blue-500 to-violet-600",
      staking: "from-violet-500 to-indigo-600",
    };
  }
  ...
  async loadPatchNotesStructureForType(type) {
    try {
      ...
      console.warn(
        `Failed to load patch notes structure for type ${type}:`,
        error
      );
    }
  }
    ...
    for (const version of typeSpecificVersions) {
      try {
        const response = await fetch(
          `content/${type}/patch-notes/${version}.md`
        );
        if (response.ok) {
  ...
  getKnownVersionsForType(type) {
    const knownVersions = {
      "affiliate": ["5.0.5", "5.0.6", "6.0.0"],
      "ai-investment": ["6.0.0"],
      "ai-market-maker": ["5.0.2", "6.0.0"],
      "core": ["5.0.0", "5.0.8", "5.0.9", "5.1.1", "5.1.3", "5.1.4", "5.1.5", "5.1.6", "5.1.7", "5.1.8", "5.2.0", "5.2.1", "5.2.2", "5.2.4", "5.2.5", "5.2.6", "5.2.7", "5.2.8", "5.2.9", "5.3.0", "5.3.1", "5.3.2", "5.3.3", "5.3.4", "5.3.5", "5.3.6", "5.3.7", "5.3.8", "5.4.0", "5.4.1", "5.4.2", "5.4.3", "5.4.4", "5.4.5", "5.4.6", "5.4.7", "5.4.8", "5.4.9", "5.5.0", "5.5.1", "5.5.2", "5.5.3", "5.5.5", "5.5.7", "5.5.8", "5.5.9", "5.6.1", "5.6.3", "5.6.4", "5.6.5", "5.6.7", "5.7.0", "5.7.1", "5.7.2", "5.7.3", "5.7.4", "5.7.6", "6.0.0", "6.0.1", "6.0.2"],
      "ecommerce": ["5.0.3", "5.0.4", "5.0.5", "5.0.6", "5.0.7", "5.0.8", "5.1.1", "5.1.5", "6.0.0"],
      "ecosystem": ["5.0.5", "5.1.1", "5.1.6", "5.1.9", "5.2.0", "5.2.3", "6.0.0"],
      "faq": ["5.0.6", "5.0.7", "6.0.0", "6.0.1"],
      "forex": ["5.0.3", "5.0.4", "5.0.5", "5.0.6", "5.1.1", "6.0.0"],
      "futures": ["5.0.4", "6.0.0", "6.0.1"],
      "gateway": ["6.0.0"],
      "ico": ["5.0.1", "5.1.4", "5.1.8", "5.2.4", "5.2.5", "5.2.6", "6.0.0"],
      "mailwizard": ["6.0.0"],
      "nft": ["6.0.0"],
      "p2p": ["5.0.0", "5.0.4", "5.0.5", "5.0.6", "5.0.7", "5.0.8", "5.1.2", "5.1.3", "5.1.7", "5.1.8", "5.2.1", "5.2.6", "5.2.7", "5.2.9", "5.3.1", "5.3.2", "5.3.3", "5.3.4", "6.0.0"],
      "staking": ["5.0.3", "5.0.7", "5.0.9", "5.1.3", "5.1.6", "6.0.0"],
    };
  ...
  updateGlobalProgress() {
    ...
    const progress =
      totalVersions > 0 ? (loadedVersions / totalVersions) * 100 : 0;
  ...
  async startLazyLoading(type, typeData) {
    ...
    const loadNextBatch = async () => {
      ...
      for (
        let i = 0;
        i < maxConcurrent && currentIndex < typeData.versions.length;
        i++
      ) {
      ...
      const loadPromises = batch.map(async ({ versionData, index }) => {
        try {
          ...
          console.warn(
            `Failed to lazy load ${type}/${versionData.version}:`,
            error
          );

          // Even on error, provide fallback content and mark as loaded
          versionData.content = this.getFallbackContent(
            type,
            versionData.version
          );
  ...
  updateVersionUI(type, version, state) {
    ...
    switch (state) {
      ...
      case "loaded":
        ...
        if (tagsContainer) {
          const loadingTag = Array.from(tagsContainer.children).find(
            (span) =>
          ...
          if (loadingTag) {
            ...
            const typeData = this.patchNotes.get(type);
            if (typeData) {
              const versionData = typeData.versions.find(
                (v) => v.version === version
              );
              if (
                versionData &&
                versionData.metadata &&
                versionData.metadata.tags
              ) {
  ...
  refreshVersionEntry(type, versionData) {
    ...
    const existingEntry = document
      .querySelector(`[onclick="togglePatchNoteVersion('${uniqueId}')"]`)
      ?.closest(".border.border-zinc-200");
  ...
  async loadVersionOnDemand(type, version) {
    ...
    try {
      ...
      console.warn(
        `Failed to load version on demand ${type}/${version}:`,
        error
      );
      versionData.isLoading = false;
      this.updateVersionUI(type, version, "error");
  ...
  async loadVersionFile(type, version) {
    try {
      ...
      if (isFileProtocol) {
        ...
        console.warn(
          `Cannot load ${type}/${version}.md via file:// protocol. Please serve via HTTP server.`
        );
...
- Using the frontend application at \`http://localhost:3000\` if available`;
  ...
  generatePatchNotesHTML() {
    ...
    const extensionTypes = Array.from(this.patchNotes.keys())
  ...
  generateTypeSection(type, typeData, isCore) {
    ...
    const title =
      type === "core" ? "Core Platform" : this.capitalizeWords(type);
  ...
  markdownToHTML(markdown) {
    ...
    return (
      content
        ...
        .replace(
          /^### (.*$)/gim,
          '<h3 class="text-lg font-semibold text-zinc-900 dark:text-zinc-100 mt-6 mb-3">$1</h3>'
        )
        .replace(
          /^## (.*$)/gim,
          '<h2 class="text-xl font-bold text-zinc-900 dark:text-zinc-100 mt-8 mb-4">$1</h2>'
        )
        .replace(
          /^# (.*$)/gim,
          '<h1 class="text-2xl font-bold text-zinc-900 dark:text-zinc-100 mb-6">$1</h1>'
        )
        // Bold text
        .replace(
          /\*\*(.*?)\*\*/g,
        ...
        .replace(
          /`([^`]+)`/g,
          '<code class="px-1.5 py-0.5 bg-zinc-100 dark:bg-zinc-800 text-zinc-900 dark:text-zinc-100 rounded text-sm font-mono">$1</code>'
        )
      ...
      if (patchNotesSystem) {
        ...
        if (typeData) {
          ...
          if (versionData && !versionData.isLoaded && !versionData.isLoading) {
            ...
            const loadedContent = await patchNotesSystem.loadVersionOnDemand(
              type,
              version
            );
            if (loadedContent) {
              ...
              if (contentDiv) {
                contentDiv.innerHTML =
                  patchNotesSystem.markdownToHTML(loadedContent);
              }
            }
          }
        }
